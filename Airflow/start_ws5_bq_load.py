    ...
    t4 = BashOperator(
        ...
        bash_command="""
            bq load \
                ...
                datawarehouse.audible_data \
                gs://asia-east2-datawarehouse-eab5d086-bucket/data/output.csv
        """
    )
...
# gsutil cp start_ws5_bq_load.py gs://asia-east2-datawarehouse-eab5d086-bucket/dags