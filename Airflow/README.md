...
<div align="center">
  <a href=""> <img src="images/logo/envilink/envilink.png" width="50%"/></a>
</div>

Project นี้ เป็นการสร้าง Data Pipeline สำหรับรวบรวมข้อมูลสิ่งแวดล้อมด้านมลพิษในอากาศ โดยเน้นไปที่ข้อมูลฝุ่น PM 2.5 และข้อมูลอื่นๆที่เกี่ยวข้อง ตามความต้องการของคณะกรรมการร่างกฎหมายมลพิษทางอากาศ ซึ่งชุดข้อมูลถูกจัดเก็บให้อยู่ในลักษณะไฟล์ดิจิทัล *JSON* และ *Parquet* รวมทั้งในรูปแบบโครงสร้างตาราง (structured table) บน Google Cloud Platform เพื่อประโยชน์ทางด้านการศึกษาและการติดตามสภาพแวดล้อมหรือปัญหาจากภัยธรรมชาติ ในเวลาปัจจุบัน
...
<div align="center">
  <table>
    ...
    <tr>
      <td align="center">
        <a href=""><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/ad/Seal_Bangkok_Metropolitan_Admin_%28green%29.svg/768px-Seal_Bangkok_Metropolitan_Admin_%28green%29.svg.png" width="100"/></a>
      </td>
      <td align="center">
...
> https://www.arcgis.com/apps/dashboards/b6af2bb153a04c5bae9b1b974c5a30a1
