...
def dpm_dpmalert() -> None:
    ...
    def raw_area() -> None:
        ...
        @task
        def fetch_api_to_gcs_raw(ti=None, data_interval_end=None) -> None:
            NOW = data_interval_end.in_tz(LOCAL_TIMEZONE)
            ...
            json_data = fetch_api_sync(
                url=r"https://dpmalert.disaster.go.th/api/app/airQualityDataHourly",
                homepage_url=r"https://dpmalert.disaster.go.th",
                params={
                    "timeMin": TS,
                    "regionId[0]": 0,
                    "provinceId": "",
                    "type": 1001,
                    "maxResultCount": 16777216,
                },
                headers={
    ...
    warehouse = data_warehouse(wh_types=["station_info", "station_reads"], parent_dags=["ccdc_dustboy"])
