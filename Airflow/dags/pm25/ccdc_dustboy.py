...
def ccdc_dustboy() -> None:
    ...
    def raw_area() -> None:
        ...
        def fetch_api_to_gcs_raw(ti=None) -> None:
            ...
            json_data = fetch_api_sync(
                url=r"https://www.cmuccdc.org/assets/api/genDustboyGeo.php?dataType=th-hr",
    ...
    warehouse = data_warehouse(wh_types=["station_info", "station_reads"], parent_dags=["pcd_air4thai"])
